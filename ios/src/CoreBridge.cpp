...
TitleBootResult attempt_prepared_title_boot(std::size_t instruction_limit) {
    ...
    if (instruction_limit == 0 || instruction_limit > maximum_controlled_boot_instructions) {
        ...
        result.touch_sampling_state_set_call_count = thread.touch_sampling_state_set_call_count;
        result.touch_sampling_state_get_call_count = thread.touch_sampling_state_get_call_count;
        result.touch_panel_info_call_count = thread.touch_panel_info_call_count;
        result.touch_pixel_density_call_count = thread.touch_pixel_density_call_count;
        result.touch_force_mode_call_count = thread.touch_force_mode_call_count;
        result.touch_buffer_call_count = thread.touch_buffer_call_count;
        result.touch_sample_count = thread.touch_sample_count;
        result.time_query_call_count = thread.time_query_call_count;
        result.rtc_tick_call_count = thread.rtc_tick_call_count;
        result.power_clock_set_call_count = thread.power_clock_set_call_count;
        result.power_clock_get_call_count = thread.power_clock_get_call_count;
        result.power_status_call_count = thread.power_status_call_count;
        result.display_wait_vblank_call_count = thread.display_wait_vblank_call_count;
        result.display_get_vcount_call_count = thread.display_get_vcount_call_count;
        result.display_refresh_rate_call_count = thread.display_refresh_rate_call_count;
        result.display_set_frame_buf_call_count = thread.display_set_frame_buf_call_count;
        result.display_get_frame_buf_call_count = thread.display_get_frame_buf_call_count;
        result.display_frame_buf_set = thread.display_frame_buf_set;
        ...
        result.touch_front_sampling_state = thread.touch_front_sampling_state;
        result.touch_back_sampling_state = thread.touch_back_sampling_state;
        result.last_touch_port = thread.last_touch_port;
        result.last_touch_buffer_address = thread.last_touch_buffer_address;
        result.last_touch_requested_count = thread.last_touch_requested_count;
        result.last_touch_result = thread.last_touch_result;
        result.last_time_value = thread.last_time_value;
        result.last_rtc_tick_address = thread.last_rtc_tick_address;
        result.last_time_result = thread.last_time_result;
        result.last_power_requested_arm_clock = thread.last_power_requested_arm_clock;
        result.last_power_requested_bus_clock = thread.last_power_requested_bus_clock;
        result.last_power_requested_gpu_clock = thread.last_power_requested_gpu_clock;
        result.last_power_requested_gpu_xbar_clock = thread.last_power_requested_gpu_xbar_clock;
        result.last_power_result = thread.last_power_result;
        result.display_vblank_count = thread.display_vblank_count;
        result.last_display_frame_buf_address = thread.last_display_frame_buf_address;
        result.last_display_frame_buf_base = thread.last_display_frame_buf_base;
        result.last_display_frame_buf_pitch = thread.last_display_frame_buf_pitch;
        result.last_display_frame_buf_pixel_format = thread.last_display_frame_buf_pixel_format;
        result.last_display_frame_buf_width = thread.last_display_frame_buf_width;
        result.last_display_frame_buf_height = thread.last_display_frame_buf_height;
        result.last_display_frame_buf_sync = thread.last_display_frame_buf_sync;
        result.last_display_result = thread.last_display_result;
