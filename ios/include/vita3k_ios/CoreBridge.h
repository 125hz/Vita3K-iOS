...
struct TitleBootResult {
    ...
    std::size_t touch_sampling_state_set_call_count{};
    std::size_t touch_sampling_state_get_call_count{};
    std::size_t touch_panel_info_call_count{};
    std::size_t touch_pixel_density_call_count{};
    std::size_t touch_force_mode_call_count{};
    std::size_t touch_buffer_call_count{};
    std::size_t touch_sample_count{};
    std::size_t time_query_call_count{};
    std::size_t rtc_tick_call_count{};
    std::size_t power_clock_set_call_count{};
    std::size_t power_clock_get_call_count{};
    std::size_t power_status_call_count{};
    std::size_t display_wait_vblank_call_count{};
    std::size_t display_get_vcount_call_count{};
    std::size_t display_refresh_rate_call_count{};
    std::size_t display_set_frame_buf_call_count{};
    std::size_t display_get_frame_buf_call_count{};
    bool display_frame_buf_set{};
    ...
    std::uint32_t touch_front_sampling_state{};
    std::uint32_t touch_back_sampling_state{};
    std::uint32_t last_touch_port{};
    std::uint32_t last_touch_buffer_address{};
    std::uint32_t last_touch_requested_count{};
    std::int32_t last_touch_result{};
    std::uint64_t last_time_value{};
    std::uint32_t last_rtc_tick_address{};
    std::int32_t last_time_result{};
    std::int32_t last_power_requested_arm_clock{};
    std::int32_t last_power_requested_bus_clock{};
    std::int32_t last_power_requested_gpu_clock{};
    std::int32_t last_power_requested_gpu_xbar_clock{};
    std::int32_t last_power_result{};
    std::uint64_t display_vblank_count{};
    std::uint32_t last_display_frame_buf_address{};
    std::uint32_t last_display_frame_buf_base{};
    std::uint32_t last_display_frame_buf_pitch{};
    std::uint32_t last_display_frame_buf_pixel_format{};
    std::uint32_t last_display_frame_buf_width{};
    std::uint32_t last_display_frame_buf_height{};
    std::uint32_t last_display_frame_buf_sync{};
    std::int32_t last_display_result{};
