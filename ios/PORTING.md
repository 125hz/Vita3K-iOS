...
| Input | Desktop paths consume SDL/controller state and frontend events | **Started:** UIKit touch samples are normalized and GameController state is captured behind a portable seam; connect this state to Vita controller/touch HLE | Physical-device Milestone 12 touch diagnostic pending |
...
13. Add a bounded host-audio adapter, then connect input/audio state to guest HLE services.
14. Only after interpreter-mode boot is stable, integrate and validate the ARM64 JIT platform layer.
